    ...
    <header>
      <nav className='container_header'>
        <div className='header_start'>
          <div className='h_box'>
            <button className='hambuger_btn' onClick={hambugerBtn}>
        ...
        <div className='header_center'>
          ...
          <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="search-button" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='header_end'>
          <button type='button' className='end_btn'>
            <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" className="end_add" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
